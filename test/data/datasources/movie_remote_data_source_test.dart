...
void main() {
  ...
  group('get Now Playing Movies', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockHttpClient.get(Uri.parse(
              '${TheMovieDBService.BASE_URL}/movie/now_playing?${TheMovieDBService.API_KEY}')))
  ...
  group('get Popular Movies', () {
    ...
    test('should return list of movies when response is success (200)',
      ...
      // arrange
      when(mockHttpClient.get(Uri.parse(
              '${TheMovieDBService.BASE_URL}/movie/popular?${TheMovieDBService.API_KEY}')))
          .thenAnswer((_) async =>
  ...
  group('get Top Rated Movies', () {
    ...
    test('should return list of movies when response code is 200 ', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse(
              '${TheMovieDBService.BASE_URL}/movie/top_rated?${TheMovieDBService.API_KEY}')))
          .thenAnswer((_) async =>
  ...
  group('get movie detail', () {
    ...
    final tMovieDetail = MovieDetailModel.fromJson(
        json.decode(readJson('dummy_data/movie/detail.json')));

    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse(
              '${TheMovieDBService.BASE_URL}/movie/$tId?${TheMovieDBService.API_KEY}')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/movie/detail.json'), 200));
      // act
  ...
  group('get movie recommendations', () {
    final tMovieList = MoviesOverviewModel.fromJson(
            json.decode(readJson('dummy_data/movie/recommendations.json')))
        .movieList;
    final tId = 1;
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      // arrange
      when(mockHttpClient.get(Uri.parse(
              '${TheMovieDBService.BASE_URL}/movie/$tId/recommendations?${TheMovieDBService.API_KEY}')))
          .thenAnswer((_) async => http.Response(
  ...
  group('search movies', () {
    final tSearchResult = MoviesOverviewModel.fromJson(json
    ...
    test('should return list of movies when response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse(
              '${TheMovieDBService.BASE_URL}/search/movie?${TheMovieDBService.API_KEY}&query=$tQuery')))
          .thenAnswer((_) async => http.Response(
